...
public:
	...
	uint32_t GetDisplayedFrameWidth() const;
	HRESULT SetDisplayedFrameWidth(uint32_t width);

	uint32_t GetDisplayedFrameHeight() const;
	HRESULT SetDisplayedFrameHeight(uint32_t height);

	uint32_t GetVisibleWidth() const;
	HRESULT SetVisibleWidth(uint32_t width);

	uint32_t GetVisibleHeight() const;
	HRESULT SetVisibleHeight(uint32_t height);
...
private:
	...
	struct
	{
		uint32_t displayedFrameWidth;
		uint32_t displayedFrameHeight;
		uint32_t visibleFrameWidth;
		uint32_t visibleFrameHeight;
	} m_constants;
};
